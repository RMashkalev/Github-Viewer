    ...
    inner class RepositoryViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            heartImageView.setOnClickListener {
                ...
                updateFavoriteIcon(repository.isFavorite)
                onItemClickListener?.onHeartClick(repository)
            }
        }
        ...
        private fun updateFavoriteIcon(isFavorite: Boolean) {
            val drawableResId = if (isFavorite) {
                R.drawable.heart_fill_svg
            } else {
                R.drawable.heart_svg
            }
            heartImageView.setImageResource(drawableResId)
        }
    }
